...
export type NotFoundErrorCodeEnum =
  (typeof NotFoundErrorCodeEnum)[keyof typeof NotFoundErrorCodeEnum];
 ...
 * @export
 */
export const ExercisesApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getExercisesBodyPartByBodyPart: async (
      bodyPart:
        | "back"
        | "cardio"
        | "chest"
      ...
      const localVarPath = `/exercises/bodyPart/{bodyPart}`.replace(
        `{${"bodyPart"}}`,
        encodeURIComponent(String(bodyPart))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    getExercisesBodyPartList: async (
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getExercisesEquipmentByEquipment: async (
      equipment:
        | "assisted"
        | "band"
        | "barbell"
      ...
      assertParamExists(
        "getExercisesEquipmentByEquipment",
        "equipment",
        equipment
      );
      const localVarPath = `/exercises/equipment/{equipment}`.replace(
        `{${"equipment"}}`,
        encodeURIComponent(String(equipment))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    getExercisesEquipmentList: async (
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getExercisesExerciseById: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getExercisesExerciseById", "id", id);
      const localVarPath = `/exercises/exercise/{id}`.replace(
        `{${"id"}}`,
    ...
    getExercisesNameByName: async (
      ...
      const localVarPath = `/exercises/name/{name}`.replace(
        `{${"name"}}`,
     ...
     * @throws {RequiredError}
     */
    getExercisesTargetByTarget: async (
      target:
        | "abductors"
        | "abs"
        | "adductors"
      ...
      const localVarPath = `/exercises/target/{target}`.replace(
        `{${"target"}}`,
  ...
  return {
    ...
    async getExercises(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<Exercise>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getExercises(
        offset,
        limit,
        sortMethod,
        sortOrder,
     ...
     * @throws {RequiredError}
     */
    async getExercisesBodyPartByBodyPart(
      bodyPart:
        | "back"
        | "cardio"
        | "chest"
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesBodyPartByBodyPart(
          bodyPart,
          offset,
          limit,
          sortMethod,
     ...
     * @throws {RequiredError}
     */
    async getExercisesBodyPartList(
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesBodyPartList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async getExercisesEquipmentByEquipment(
      equipment:
        | "assisted"
        | "band"
        | "barbell"
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesEquipmentByEquipment(
          equipment,
          offset,
          limit,
          sortMethod,
     ...
     * @throws {RequiredError}
     */
    async getExercisesEquipmentList(
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesEquipmentList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async getExercisesExerciseById(
      id: string,
      options?: AxiosRequestConfig
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesExerciseById(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesNameByName(
          name,
          offset,
          limit,
          sortMethod,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesTargetByTarget(
          target,
          offset,
          limit,
          sortMethod,
     ...
     * @throws {RequiredError}
     */
    async getExercisesTargetList(
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getExercisesTargetList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const ExercisesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getExercisesBodyPartByBodyPart(
      bodyPart:
        | "back"
        | "cardio"
        | "chest"
...
export class ExercisesApi extends BaseAPI {
  ...
  public getExercises(
    ...
    return ExercisesApiFp(this.configuration)
      .getExercises(offset, limit, sortMethod, sortOrder, options)
   ...
   * @memberof ExercisesApi
   */
  public getExercisesBodyPartByBodyPart(
    bodyPart:
      | "back"
      | "cardio"
      | "chest"
   ...
   * @memberof ExercisesApi
   */
  public getExercisesEquipmentByEquipment(
    equipment:
      | "assisted"
      | "band"
      | "barbell"
   ...
   * @memberof ExercisesApi
   */
  public getExercisesTargetByTarget(
    target:
      | "abductors"
      | "abs"
      | "adductors"
...
export const MiscApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getImageById(
        id,
        options
      );
      return createRequestFunction(
